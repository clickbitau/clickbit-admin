...
export default function CustomerDashboardPage() {
  ...
  const modules = [
    { href: '/invoices', label: 'Invoices', icon: Receipt, count: dashboard.invoice_count },
    { href: '/orders', label: 'Orders', icon: ShoppingCart, count: dashboard.order_count },
    { href: '/projects', label: 'Projects', icon: FolderKanban, count: dashboard.project_count },
    { href: '/payments', label: 'Payments', icon: CreditCard, count: dashboard.payment_count },
    { href: '/documents', label: 'Documents', icon: Files, count: dashboard.document_count },
    { href: '/tasks', label: 'Tasks', icon: ListTodo, count: dashboard.task_count },
    { href: '/tickets', label: 'Tickets', icon: Ticket, count: dashboard.ticket_count },
  ];
