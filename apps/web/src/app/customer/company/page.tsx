...
export default function CustomerCompanyPage() {
  ...
  const company = (data?.data ?? null) as {
  ...
  if (isLoading) {
    return (
      <PageShell title="Company" icon={Building2}>
  ...
  return (
    <PageShell title="Company Profile" icon={Building2} description="View your company information">
      <div className="max-w-4xl mx-auto space-y-4">
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="pt-6 border-t border-border/50 flex items-center gap-2 text-xs text-muted-foreground">
