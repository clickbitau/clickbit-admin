...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    links: [
      { href: '/admin/crm/project-tasks', label: 'My Tasks', icon: ListTodo },
      { href: '/admin/hr/time-clock', label: 'Time Clock', icon: Clock },
      { href: '/admin/hr/time-off', label: 'Time Off', icon: Calendar },
      { href: '/admin/hr/payslips', label: 'Payslips', icon: Banknote },
      { href: '/admin/hr/contracts', label: 'My Contracts', icon: FileText },
    ],
  },
  {
    id: 'crm',
