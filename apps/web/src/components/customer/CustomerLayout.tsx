...
const navItems: NavItem[] = [
  ...
  { href: '/customer/documents', label: 'Documents', icon: Files },
  { href: '/customer/tasks', label: 'Tasks', icon: ListTodo },
  ...
  const Nav = ({ collapsed = false }: { collapsed?: boolean }) => (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-6 mt-4 px-3">
        {!collapsed && (
          <Link href="/customer/dashboard" className="flex items-center gap-2 px-2">
